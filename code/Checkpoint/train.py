...
images_cars = glob.glob('../data/vehicles/vehicles/KITTI_extracted/*.png')
images_notcars = glob.glob('../data/non-vehicles/non-vehicles/GTI/*.png')
cars = []
notcars = []
...
sample_size_cars = 2500
sample_size_notcars = 2500
